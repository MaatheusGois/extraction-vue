<template>
  ...
  export default {
    data() {
      return {
        archives: [
          { name: "archives", value: "archiveIds%5B%5D=1", id: "customCheck1", label: "Anais de Eventos" },
          { name: "archives", value: "archiveIds%5B%5D=2", id: "customCheck2", label: "Periódicos" },
          { name: "archives", value: "archiveIds%5B%5D=3", id: "customCheck3", label: "Livros e relatórios" }
          // Adicione mais opções de arquivo conforme necessário
        ]
      };
    },
    methods: {
